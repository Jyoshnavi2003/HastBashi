...
'voice', 'wednesday', 'weight','please wait for sometime','what is your mobile number','what are you doing','are you busy']
        ...
        with sr.Microphone() as source:
                ...
                while True:
                        ...
                        audio = r.listen(source) #here audio is blob
                        # recognize speech using Sphinx
                        try:
                                a=r.recognize_google(audio) #using google to recognize word, it will return text
                                a = a.lower() #converting the text to lower case
                                print('You Said: ' + a.lower()) #printing what has been told
                                ...
                                if(a.lower()=='goodbye' or a.lower()=='good bye' or a.lower()=='bye'):
                                        ...
                                        break #this is to stop the application, beacuse we used while true to run
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'ISL_Gifs/{are you hungry}.gif'.format(a.lower()))
                                    root.mainloop()
                                else:
